...
public class Test {
	private static final String PATH = "ma/lndroid/tp/spring/jdbc/template/result/set/extractor/applicationContext.xml";
	...
	public static void main(String[] args) {
		...
		System.out.println("#Fetching by ResultSetExtractor: Get List Of All Employees in Database DB");
