package ma.lndroid.tp.spring.orm.hibernate.template;
...
public class Test {
	private static final String PATH = "ma/lndroid/tp/spring/orm/hibernate/template/applicationContext.xml";
	
	public static void main(String[] args) {
		System.out.println("START HIBERNATE TEMPLATE  EXAMPLE ...");
