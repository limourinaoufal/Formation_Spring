...
public class Test {
	private static final String PATH = "ma/lndroid/tp/spring/orm/hibernate/session/factory/applicationContext.xml";
	
	public static void main(String[] args) {
		System.out.println("START HIBERNATE Session Factory Example ...");
