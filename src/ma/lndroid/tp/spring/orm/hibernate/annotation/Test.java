...
public class Test {
	private static final String PATH = "ma/lndroid/tp/spring/orm/hibernate/annotation/applicationContext.xml";
	
	public static void main(String[] args) {
		System.out.println("START HIBERNATE With Annotation EXAMPLE ...");
