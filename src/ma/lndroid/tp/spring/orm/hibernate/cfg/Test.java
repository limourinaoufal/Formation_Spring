...
public class Test {
	private static final String PATH = "ma/lndroid/tp/spring/orm/hibernate/cfg/applicationContext.xml";
	
	public static void main(String[] args) {
		System.out.println("START HIBERNATE With cfg.xml config EXAMPLE ...");
